...
-   `majestic_million.csv` — download from majestic.com
-   Training data (`data_35k.csv`, `data_10k.csv`, `data_test.csv`) — generated by `training/split_data.py` from your own collected dataset
